...
/// The timers / microtask / events / os surface of the Node compat layer,
/// as one JS bootstrap evaluated by [installNodeCompat] right after the
/// core prelude. Split out of the core IIFE for size: it shares state
/// through `globalThis.__ncConfig` (read-only) and
/// `globalThis.__ncBuiltins` (require-module registration), never by
/// closure.
const String nodeCompatAsyncPrelude = r'''
(function () {
